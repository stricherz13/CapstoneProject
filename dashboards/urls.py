...
from .views import StLouisLandTaxDashboard2022, LRADashboard, StLouisLandTaxDashboard2023, StCharlesCountyLandTaxDashboard
...
urlpatterns = [
    ...
    path("2022StCharlesCountyLandTaxDashboard", StCharlesCountyLandTaxDashboard.as_view(), name="StCharlesCountyLandTaxDashboard")
]